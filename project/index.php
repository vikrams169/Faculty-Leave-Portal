...
<div class="w3-top">
  <div class="w3-bar w3-white w3-card" id="myNavbar">
    ...
    <div class= "w3-padding-left-16" style="margin-top:5px;padding-left:15px;padding-right:15px">
     <form action="phase2/view_profile_other.php" method="post">
  <input type="text" placeholder="Enter Faculty ID" name="faculty_id_view" required>
