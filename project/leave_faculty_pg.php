<?php 
  ...
  $sql_query_2 = "SELECT * FROM faculty WHERE facultyID = '$faculty_id'" ; 
...
<!--Hi message-->
  <div class="w3-col s8 w3-bar" style="padding-left:15px">
	<h2>Hi <strong><?php echo htmlspecialchars($faculty_name);?></strong></h2>
  </div>
...
<!-- leave ID -->
  ...
  <form class="w3-container w3-card-4 w3-white" action="#" method="post">
    <p> 
    <div style="text-color: white">
    <label style="font-color: white">Comment:</label>
    <input class="w3-input w3-border" type="text" name="Comment" required></p>
...
<?php 
    ...
    $result = mysqli_query($conn, "CALL edit_leave_application('$leave_id', '$designation', '$comment', ' ')") ;
