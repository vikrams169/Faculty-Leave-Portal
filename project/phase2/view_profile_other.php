<?php 
	...
	$faculty_id_view = $_POST['faculty_id_view'];
	$_SESSION['faculty_id_view'] = $faculty_id_view;

	require "../vendor/autoload.php" ; 
    $client = (new MongoDB\Client);
    $collection = $client->leave_portal_db->faculty_details;

    $document = $collection->findOne(['faculty_id' => $_SESSION['faculty_id_view']]);

    $go_back_loc = '../index.php';
    if($_SESSION['logged_in'] == 'yes'){
    	$go_back_loc = 'view_profile_own.php';
    }
...
<!DOCTYPE html>
<html>
<title>View Other's Profile</title>
<meta charset="UTF-8">
...
<div class="w3-top">
  <div class="w3-bar w3-white w3-card" id="myNavbar">
    <a href="<?= $go_back_loc ?>" class="w3-bar-item w3-button w3-small">GO BACK</a>
